...
export class AuthService {
  ...
  constructor(
    ...
    this.JWT_ACCESS_TOKEN_TTL = Number(this.configService.getOrThrow('JWT_ACCESS_TOKEN_TTL'));
    this.JWT_REFRESH_TOKEN_TTL = Number(this.configService.getOrThrow('JWT_REFRESH_TOKEN_TTL'));
...
console.log('REFRESH TTL:', typeof this.JWT_REFRESH_TOKEN_TTL, this.JWT_REFRESH_TOKEN_TTL);
  ...
  private auth(res: Response, id: string) {
    ...
    this.setCookie(res, refreshToken, new Date(Date.now() + this.JWT_REFRESH_TOKEN_TTL * 1000))
